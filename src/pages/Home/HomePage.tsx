    ...
    <>
      ...
      <section className="mb-4 leading-relaxed">
        ...
        <p>
          <ul>
            <li>
              <strong>Supports Twitch clip and YouTube video links</strong>
            </li>
            <li>
              <strong>Integrates with Twitch chat</strong>
              <p>
                gathers links from messages to build the queue, by default from your chat but can join arbitrary
                channels
              </p>
            </li>
            <li>
